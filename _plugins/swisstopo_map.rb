def swisstopo(map_center_lat, map_center_lon, scale, pkts)
  ...
  # MapLibre renders swisstopo's style; see script/swisstopo/basic.js for why the
  # ArcGIS SDK could not. Pinned so an upstream release cannot change the map
  # without a commit here.
  "<figure>
<div id=\"viewDiv\"></div>
<link rel=\"stylesheet\" href=\"https://unpkg.com/maplibre-gl@6.4.1/dist/maplibre-gl.css\">
<script>
